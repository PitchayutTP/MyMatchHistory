    ...
    >
        ...
        >
            <div class="">
                ...
                <div
                    v-else
                    class="flex aspect-video w-full items-center justify-center bg-gray-700 text-white"
                >
            ...
            <div class="p-6">
                ...
                <div class="mb-6 rounded-lg bg-gray-100 p-4 text-center">
                    ...
                    <span
                        class="ml-2 px-3 py-1 align-middle text-sm font-semibold uppercase tracking-wider"
                        :class="{
